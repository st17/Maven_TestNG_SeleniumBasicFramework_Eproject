...
public class Register_Page {
    public static String ClickRegisterlink = ".//a[@href='faces/registry.xhtml']";
    public static String Taikhoan = ".//input[@name='j_idt9:soucre']";
    public static String Matkhau = ".//input[@name='j_idt9:pwd1']";
    ...
    public static String Email = ".//input[@name='j_idt9:email']";
    public static String ClickDangkyBt = ".//span[text()='Đăng ký']";
    public static String ClickTaotaikhoanBt = ".//input[@name='j_idt9:j_idt27']";
