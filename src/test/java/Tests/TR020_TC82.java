...
public class TR020_TC82 {
    ...
    //Verify that the function "sort by date entered and current date" is displayed when the user views the Opportunity details
    @Test
    public void show_SortOpportunity() throws IOException {
        ...
        {
            ex1.setTC_ID("87");
            ex1.setTC_Summary("Verify that the function \"sort by date entered and current date\" is displayed when the user views the Opportunity details");
            ex1.setTC_Result("Failed");
            ex1.setTC_Note("TC_82");
        } else {
            ex1.setTC_ID("87");
            ex1.setTC_Summary("Verify that the function \"sort by date entered and current date\" is displayed when the user views the Opportunity details");
