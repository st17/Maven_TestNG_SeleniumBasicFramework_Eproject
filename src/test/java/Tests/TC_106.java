...
public class TC_106 {
    ...
    //Verify that data is displayed in "Campaign type" list when user create "Campaign Type" success
    @Test
    public void check_insertData() throws IOException {
        ...
        ob1.setCampaignTypeName("Marketing online");
        Campaign_Action.searchCampaignTypeName(ob1, dr);
        if (dr.findElement(By.xpath("//td[text()='Marketing online']")).isDisplayed() == true) {
            ex1.setTC_ID("75");
            ex1.setTC_Summary("Verify that data is displayed in \"Campaign type\" list when user create \"Campaign Type\" success");
