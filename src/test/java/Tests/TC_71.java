...
public class TC_71 {
    ...
    //Verify that Opportunities List displays when user selects "Show Opportunities"
    @Test
    public void click_showAllOpportinitys() throws IOException {
        ...
        if (dr.findElement(By.xpath("//strong[text()='Show All Opportunities']")).isDisplayed() == true) {
            ex1.setTC_ID("79");
            ex1.setTC_Summary("Verify that Opportunities List displays when user selects \"Show Opportunities\"");
            ex1.setTC_Result("Passed");
            ex1.setTC_Note("TC_71");
        } else {
            ex1.setTC_ID("79");
            ex1.setTC_Summary("Verify that Opportunities List displays when user selects \"Show Opportunities\"");
